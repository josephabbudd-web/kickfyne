...
const (
	...
	docTemplate = `/*
Package {{ call .Funcs.LowerCase .PackageName }} is an AppTabs screen package.
An AppTabs screen lays out a tabbar above, below, left or right of where the TabItem's content is displayed.
