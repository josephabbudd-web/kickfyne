...
func New{{ .PanelName }}Panel(screen *_misc_.Miscellaneous, tabItemContentConsumer *_types_.AppTabsTabItemContentConsumer, tabItem *container.TabItem, preset *_{{ call .Funcs.LowerCase .PanelName }}panel_.Preset) (panel *{{ .PanelName }}Panel, err error) {
