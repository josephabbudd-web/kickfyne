...
func New{{ .PanelName }}Panel(screen *_misc_.Miscellaneous, tabItemContentConsumer *_types_.DocTabsTabItemContentConsumer, tabItem *container.TabItem, startupData *_startup_.{{ .PanelName }}PanelInitData) (panel *{{ .PanelName }}Panel, err error) {
